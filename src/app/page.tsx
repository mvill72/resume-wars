    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* CTA Buttons */}
          <div className={`flex flex-col sm:flex-row gap-4 justify-center mb-16 transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <Link
              href="/upload"
              className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 transition-all duration-200 text-lg hover:scale-105 transform"
            >
              Upload Your Resume
            </Link>
            <button
          ...
          {/* Features Grid */}
          <div id="features" className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mt-40">
            ...
            <div className={`bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-blue-400/20 transition-all duration-700 delay-600 hover:scale-105 transform hover:border-blue-400/40 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="text-4xl mb-4">🏆</div>
            ...
            <div className={`bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-blue-400/20 transition-all duration-700 delay-700 hover:scale-105 transform hover:border-blue-400/40 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="text-4xl mb-4">💡</div>
